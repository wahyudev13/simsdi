@extends('layouts.app')
@section('title', 'Pengingat SIP')
@section('pengingat1', 'active')
@section('pengingat2', 'show')
@section('pengingat-sip', 'active')
@section('body')
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Pengingat SIP</h1>
    <p class="mb-4">Surat Ijin Praktik Perawat / Dokter yang Sudah Berakhir</p>
