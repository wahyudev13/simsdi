...
@section('body')
    ...
    <div class="card shadow mb-4">
        <input type="hidden" class="id-pegawai" value="{{ $pengguna->id_pegawai }}">
        ...
        <div class="card-body">
            <div class="container-fluid">
                ...
                @else
                    <div class="alert alert-warning mt-2">Anda tidak memiliki akses untuk melihat data STR</div>
                @endcan
            </div>
            <!-- /.container-fluid -->
        </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="container-fluid mt-4 mb-4">
                ...
                @else
                    <div class="alert alert-warning mt-2">Anda tidak memiliki akses untuk melihat data SIP</div>
                @endcan
            </div>
            <!-- /.container-fluid -->
        </div>
...
@push('custom-scripts')
    ...
    @include('components.script-berkas-kepegawaian.sip-script', [
        ...
        'idpegawai' => 'idpegawai',
        'permissionsSIP' => [
            'view' => auth()->user()->can('user-sip-view'),
            'edit' => auth()->user()->can('user-sip-edit'),
            'delete' => auth()->user()->can('user-sip-delete'),
        ],
        'modalParent' => '#modaladdSIP',
        'editModalParent' => '#modaleditSIP',
        'routePDF' => '/pengguna/sip/view/',
        'aksesPage' => 'user',
    ])
