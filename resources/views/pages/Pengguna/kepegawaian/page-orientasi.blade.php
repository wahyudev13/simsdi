...
@push('custom-scripts')
    ...
    @include('components.script-berkas-kepegawaian.orientasi-script', [
        ...
        'orientasiRoute' => 'pengguna.getOrientasi',
        'orientasiStoreRoute' => 'pengguna.orientasi.store',
        'orientasiEditRoute' => 'pengguna.orientasi.edit',
        'orientasiUpdateRoute' => 'pengguna.orientasi.update',
        'orientasiDestroyRoute' => 'pengguna.orientasi.destroy',
        'enablePaging' => false,
        'enableSearch' => false,
        'enableInfo' => false,
        'viewRoutePDF' => '/pengguna/orientasi/view/',
        'aksesPage' => 'user',
        'permissions' => [
            'view' => auth()->user()->can('user-orientasi-view'),
            'edit' => auth()->user()->can('user-orientasi-edit'),
            'delete' => auth()->user()->can('user-orientasi-delete'),
        ],
    ])
        ...
        $(document).ready(function() {
            $('#tb-orientasi').DataTable({
                ...
                columns: [{
                    ...
                    @if (auth()->user()->can('user-orientasi-view') || auth()->user()->can('user-orientasi-edit') || auth()->user()->can('user-orientasi-delete'))
                        {
                            data: null,
                            render: function(data, row, type) {
                                return `
