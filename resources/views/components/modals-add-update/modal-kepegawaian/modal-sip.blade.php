            ...
            <div class="modal-body">
                ...
                <form method="POST" id="form-tambah-sip" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-warning btn-login" id="add_sip">Simpan</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" id="form-edit-sip" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-warning btn-login" id="submit_edit_sip">Update</button>
                        <button class="btn btn-warning btn-login-disabled d-none" type="button" disabled>
                            <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                            Loading...
                        </button>
