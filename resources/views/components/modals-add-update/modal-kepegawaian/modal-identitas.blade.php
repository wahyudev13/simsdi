    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="error_list_identitas"></div>
                <form method="POST" id="form-tambah-identitas" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success" id="add_identitas">Simpan</button>
                        <button type="submit" class="btn btn-success d-none" id="add_identitas_disabled" disabled>
...
<div class="modal fade" id="modaledit_Identitas" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="error_list_identitas_edit"></div>
                <form method="POST" id="form-edit-identitas" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" id="id-identitas-edit" name="id">
                    <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-success" id="update_identitas">Update</button>
                        <button type="submit" class="btn btn-success d-none" id="update_identitas_disabled"
                            disabled>
                            <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                            Loading...
                        </button>
