    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="javascript:void(0)" id="form-tambah-rw" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-info" id="add_riwayat">Simpan</button>
                        <button type="submit" class="btn btn-info d-none" id="add_riwayat_disabled" disabled>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" id="form-edit-riwayat" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-info" id="update_riwayat">Update</button>
                        <button type="submit" class="btn btn-info d-none" id="update_riwayat_disabled_edit"
                            disabled>
                            <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                            Loading...
                        </button>
